...
<%
	PqsDto notice = (PqsDto) request.getAttribute("qna");
	...
	<jsp:include page="/project/menu.do" />
	 ...
	 <div class="p-5 mb-4 bg-body-tertiary rounded-3">
      <div class="container-fluid py-5">
		...
		<form name="newUpdate" action="/QnaUpdateAction.do?num=<%=notice.getNum()%>&pageNum=<%=nowpage%>" method="post">
			<div class="mb-3 row">
			...
			<div class="mb-3 row">
				<div class="col-sm-offset-2 col-sm-10 ">
					...
					<c:if test="${sessionId==userId}">
						<p>
							<a	href="/QnaDeleteAction.do?num=<%=notice.getNum()%>&pageNum=<%=nowpage%>" class="btn btn-danger"> 삭제</a> 
