...
<div class="container py-4">
 ...
 <div class="p-5 mb-4 bg-body-tertiary rounded-3">
	...
	<div class="container">
		<form name="newMember"action="/project/member/processUpdateMember.do" method="post" onsubmit="return checkForm()">
				<div class="mb-3 row">
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-offset-2 col-sm-10 ">
					...
					<a href="/project/member/deleteMember.do" class="btn btn-primary">회원탈퇴</a>
				</div>
			</div>
		</form>	
	</div>
